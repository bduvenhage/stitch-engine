/*
 * $Id: PointLight.cpp 298 2015-03-25 13:00:40Z bernardt.duvenhage $
 */
/*
 *  PointLight.cpp
 *  StitchEngine
...
//=======================================================================//
#ifdef USE_OSG
osg::ref_ptr<osg::Node> stitch::PointLight::constructOSGNode(const bool createOSGLineGeometry, const bool createOSGNormalGeometry, const bool wireframe, const uintptr_t key) const
{
...
//=======================================================================//
void stitch::PointLight::calcIntersection(const Ray &ray, Intersection &intersect) const
{
...
//=======================================================================//
void stitch::PointLight::radiate(const float time, std::vector<Photon *> &photonVector, const Vec3 blockerDirection, float blockerSubtendHA) const
{
    ...
    
    {
        ...
        {
            Vec3 radiateDirection(Vec3::randNorm());
...
void stitch::PointLight::radiate(const float time, std::vector<Photon *> &photonVector) const
{
