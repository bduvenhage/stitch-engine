/*
 * $Id: PhotonMapRenderer.h 298 2015-03-25 13:00:40Z bernardt.duvenhage $
 */
/*
 *  PhotonMapRenderer.h
 *  StitchEngine
...
#ifndef STITCH_PHOTON_MAP_RENDERER_H
#define STITCH_PHOTON_MAP_RENDERER_H
...
namespace stitch {
    ...
    /*! Photon map renderer that does not make use of final gather. */
    class PhotonMapRenderer : public ForwardRenderer
    {
    public:
        PhotonMapRenderer(Scene * const scene);
        
        virtual ~PhotonMapRenderer()
        {
...
#endif// STITCH_PHOTON_MAP_RENDERER_H
