/*
 * $Id: GlossyMaterial.cpp 298 2015-03-25 13:00:40Z bernardt.duvenhage $
 */
/*
 *  GlossyMaterial.cpp
 *  StitchEngine
...
//=======================================================================//
stitch::Vec3 stitch::GlossyMaterial::stochasticSpecReflectRay(const Vec3 &toVertex, const Vec3 &normal) const
{
    Vec3 scatteredDir;
    ...
    while (scatteredDir.lengthSq()==0.0f)
    {
        ...
        const Vec3 scatterDir_relative_to_spec_reflect=Vec3::randGaussianLobe(sd_);
...
//=======================================================================//
stitch::Photon stitch::GlossyMaterial::scatterPhoton_direct(const Vec3 &normal, const Vec3 &worldPosition, const Photon &photon) const
{
    ...
    if (scatteredEnergy.lengthSq()>0.0f)
    {
        while (scatteredDir.lengthSq()==0.0f)
        {
            ...
            //if ((scatteredDir*litNormal)<0.0f)
            //{
            //    scatteredDir.setZeros();//set to zeros so that a new scatter dir may be generated.
            //}
        }
    }
