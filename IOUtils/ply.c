/*
 * $Id: ply.c 298 2015-03-25 13:00:40Z bernardt.duvenhage $
 */
/*
...
int equal_strings(char const * , char const *);

/* find an element in a plyfile's list */
PlyElement *find_element(PlyFile *, char *);

/* find a property in an element's list */
PlyProperty *find_property(PlyElement *, char const * const, int *);
...
PlyProperty *find_property(PlyElement *elem, char const * const prop_name, int *index)
{
    int i;
...
int get_prop_type(char *type_name)
{
    ...
    for (i = PLY_START_TYPE + 1; i < PLY_END_TYPE; i++)
        if (equal_strings (type_name, type_names[i]) || equal_strings (type_name, old_type_names[i]))
            return (i);
